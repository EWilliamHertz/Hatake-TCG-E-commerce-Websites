...
export const RetailerInfoPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Retailer info request submitted:', formData);
    setTimeout(() => {
  ...
  return <div className="container mx-auto px-4 py-12 max-w-4xl">
      ...
      <p className="text-center mb-8 text-gray-600 dark:text-gray-300">
        Interested in stocking Hatake TCG products? We offer competitive
        wholesale pricing.
      </p>
